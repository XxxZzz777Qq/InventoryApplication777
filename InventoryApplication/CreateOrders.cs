...
namespace InventoryApplication
{
    public partial class CreateOrders : Form
    {
        ...
        // Выбирает всю строку - Таблица клиентов целиком
        ...
        // Выбирает всю строку - Таблица продуктов
        ...
        // Вычисляет общую сумму в текущем заказе
        ...
        // Кнопка - Удаляет товар из заказа
        ...
        // Обновляет сетку товаров после удаления товара из заказа
        ...
        // Кнопка - Добавляет товар в заказ
        ...
        // Обновляет таблицу товаров при добавлении товаров в заказ
        ...
        // Проверяет повторяющуюся запись о продукте и добавленные количества
        ...
        // Проверяет, что добавленное количество меньше, чем количество на складе
        ...
        // Проверяет таблицу заказов на наличие повторяющихся записей
        ...
        // Кнопка - Вставляет в таблицу заказов
        ...
        // Захватывает OrderID - вставляет в таблицу продаж
        ...
        // Обновляет таблицу продуктов при создании заказа
